...
Route::name('excel-collection')->get('/excel-from-collection', 'ExcelController@exportExcelFromCollection');
Route::name('store-excel-collection')->get('/store-excel-collection', 'ExcelController@storeExcelFromCollection');
Route::name('download-excel-collection')->get('/download-excel-collection', 'ExcelController@downloadExcelCollection');
