...
Route::name('store-excel')->get('/store-excel', 'ExcelController@storeExcel');
Route::name('download-collection-excel')->get('/download-collection-excel', 'ExcelController@downloadExcel');
